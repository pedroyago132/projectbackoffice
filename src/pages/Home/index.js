...
import { Container, Input, Title, FormControl, Logo, SubTitle, Body, Container1, ImageBackground, CleanTextField } from './styles';
  ...
  return (
    <>
      <Body>
        ...
        <Container1>
          <ImageBackground id='logoa' src='/medical.jpeg' />
        </Container1>
        <Snackbar
